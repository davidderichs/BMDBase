...
/*Ende der Klassen Variablen -----------------------------------------*/
	...
	public Film(int id, String nameDE, String nameEN, int jahr, String regie,String produzent, String studio, String land, int fsk, int laenge, String sprache,String darsteller, String kanal, String genere, int bewertung) throws FilmDatenException   
	{
		this.id = id;
		titelDE = nameDE;
		titelEN = nameEN;
